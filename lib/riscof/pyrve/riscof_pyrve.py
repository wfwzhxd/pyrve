...
class pyrve(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","pyrve.sh")
    ...
    def initialise(self, suite, work_dir, archtest_env):
       ...
       # runTests function
       self.compile_cmd = '~/xpack-riscv-none-elf-gcc-13.2.0-2/bin/riscv-none-elf-gcc -march={0} \
    ...
    def runTests(self, testList):
	  ...
	  # echo statement.
          if self.target_run:
            ...
            simcmd = self.dut_exe + ' {} {}'.format(elf, sig_file)
          else:
            simcmd = 'echo "NO RUN"'
